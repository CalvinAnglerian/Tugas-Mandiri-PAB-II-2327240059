...
class DetailScreen extends StatelessWidget {
  ...
  String generatedAvatarUrl(String? fullName) {
    ...
    final randomColor =
        colors[formattedName.length % colors.length];
...
// import 'package:spbu_app/models/post.dart';
// import 'package:spbu_app/screens/map_detail_screen.dart';
// import 'package:spbu_app/services/post_service.dart';
// import 'package:firebase_auth/firebase_auth.dart';
// import 'package:flutter/material.dart';
// import 'package:share_plus/share_plus.dart';
...
//                           children: [
//                             Text(
//                               post.title ?? 'SPBU', //sssss
//                               style: const TextStyle(
//                                 fontSize: 26, fontWeight:FontWeight.bold, color: Color(0xFF222222),  
//                               ),
//                             ),
...
//                               children: [
//                                 const Icon(
//                                   Icons.location_on, color: Color(0xFFF3122F), size: 22),
//                                   const SizedBox(width: 6),
//                                   Expanded(
//                                     child: 
//                                       Text(
...
//                             Text(
//                               post.description ?? '',
//                               style: const TextStyle(fontSize: 16, color: Color(0xFF555555), height: 1.8),
//                             ),
...
//                                       children: [
//                                         const Icon(
//                                           Icons.gps_fixed, size: 18, color: Colors.grey,
//                                         ),
